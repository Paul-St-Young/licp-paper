...
\caption{Valence electron Compton profiles of solid (solid line) and liquid (dashed line) lithium from QMC (thin) and experiment (thick). The top panel shows the Compton profiles on an absolute scale. The bottom panel shows  $\Delta J(p)=J_{QMC}-J_{exp}$.}%the QMC Compton profiles relative to the experiment.
\label{fig:sl-jp-djp}
\end{figure}
...
\caption{Difference between solid and liquid valence electron Compton profiles.\label{fig:s-l-djp}}
\end{figure}
