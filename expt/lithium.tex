...
%An important goal for electron momentum density measurements is to directly observe the momentum distribution of electrons in metals and determine the renormalization factor $Z_{k_F}$.
...
Solid      &      &\footnotesize{II} & 0.74 & 0.084 & 0.66 & 0.80 \\
              &      &\footnotesize{III} & 0.68 & 0.113 & 0.57 & 0.68 \\ % \hline
...
Note this function becomes Lorentzian using the parameters (1, 1, 0) while effectively Gaussian using the parameters (0.6, 0.3, 0.1). % as Taylor series. 
